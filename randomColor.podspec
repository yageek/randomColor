Pod::Spec.new do |s|
  ...
  s.osx.source_files  = "Classes/YGColorDefinition.{h,m}", "Classes/NSColor+randomColor.{h,m}"
  s.ios.source_files  = "Classes/YGColorDefinition.{h,m}", "Classes/UIColor+rancomColor.{h,m}"
  s.osx.public_header_files = "Classes/YGColorDefinition.h", "Classes/NSColor+randomColor.h"
  s.ios.public_header_files = "Classes/YGColorDefinition.h", "Classes/UIColor+randomColor.h"
